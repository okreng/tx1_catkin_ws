...
if("FALSE" STREQUAL "TRUE")
  set(teb_local_planner_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/utilities/navigation/teb_local_planner)
...
if(NOT "include;/usr/include/suitesparse;/opt/ros/indigo/include/g2o " STREQUAL " ")
  set(teb_local_planner_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/suitesparse;/opt/ros/indigo/include/g2o")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teb_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/install/${idir}'.  Ask the maintainer 'Christoph Rösmann <christoph.roesmann@tu-dortmund.de>' to fix it.")
    endif()
