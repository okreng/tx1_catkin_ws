...
echo_and_run cd "/home/ubuntu/catkin_ws/src/utilities/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/ubuntu/catkin_ws/build/utilities/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
