...
"""autogenerated by genpy from loco_msgs/Trajectory.msg. Do not edit."""
import sys
...
class Trajectory(genpy.Message):
  _md5sum = "3a74ac5075578772aa67d8d934ed8ef5"
  _type = "loco_msgs/Trajectory"
...
float64 y
float64 z"""
  __slots__ = ['header','timestep','execution_mode','states','commands']
  _slot_types = ['std_msgs/Header','float32','int32','nav_msgs/Odometry[]','geometry_msgs/Twist[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,timestep,execution_mode,states,commands
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_fi.pack(_x.timestep, _x.execution_mode))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.timestep, _x.execution_mode,) = _struct_fi.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.states = []
