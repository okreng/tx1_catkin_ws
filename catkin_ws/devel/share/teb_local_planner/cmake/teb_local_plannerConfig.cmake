...
if("TRUE" STREQUAL "TRUE")
  set(teb_local_planner_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/navigation/teb_local_planner)
  set(teb_local_planner_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(teb_local_planner_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT "/home/ubuntu/catkin_ws/devel/include;/home/ubuntu/catkin_ws/src/navigation/teb_local_planner/include;/usr/include/suitesparse;/opt/ros/indigo/include/g2o " STREQUAL " ")
  set(teb_local_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/devel/include;/home/ubuntu/catkin_ws/src/navigation/teb_local_planner/include;/usr/include/suitesparse;/opt/ros/indigo/include/g2o")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teb_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/navigation/teb_local_planner/${idir}'.  Ask the maintainer 'Christoph Rösmann <christoph.roesmann@tu-dortmund.de>' to fix it.")
    endif()
...
set(teb_local_planner_EXPORTED_TARGETS "teb_local_planner_generate_messages_cpp;teb_local_planner_generate_messages_lisp;teb_local_planner_generate_messages_py;teb_local_planner_gencfg")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${teb_local_planner_dep}_FOUND)
      find_package(${teb_local_planner_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${teb_local_planner_dep} REQUIRED ${depend_list})
  endif()
