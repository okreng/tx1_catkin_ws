...
if("TRUE" STREQUAL "TRUE")
  set(vesc_msgs_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/utilities/vesc/vesc_msgs)
  set(vesc_msgs_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(vesc_msgs_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT "/home/ubuntu/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/utilities/vesc/vesc_msgs/${idir}'.  Ask the maintainer 'Michael T. Boulet <boulet@ll.mit.edu>' to fix it.")
    endif()
...
set(vesc_msgs_EXPORTED_TARGETS "vesc_msgs_generate_messages_cpp;vesc_msgs_generate_messages_lisp;vesc_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${vesc_msgs_dep}_FOUND)
      find_package(${vesc_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${vesc_msgs_dep} REQUIRED ${depend_list})
  endif()
