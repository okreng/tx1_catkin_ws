...
if("TRUE" STREQUAL "TRUE")
  set(vesc_driver_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/utilities/vesc/vesc_driver)
  set(vesc_driver_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(vesc_driver_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT "/home/ubuntu/catkin_ws/src/utilities/vesc/vesc_driver/include " STREQUAL " ")
  set(vesc_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/src/utilities/vesc/vesc_driver/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/utilities/vesc/vesc_driver/${idir}'.  Ask the maintainer 'Michael T. Boulet <boulet@ll.mit.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${vesc_driver_dep}_FOUND)
      find_package(${vesc_driver_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${vesc_driver_dep} REQUIRED ${depend_list})
  endif()
