...
if("TRUE" STREQUAL "TRUE")
  set(laser_scan_splitter_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/utilities/scan_tools/laser_scan_splitter)
  set(laser_scan_splitter_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(laser_scan_splitter_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT "/home/ubuntu/catkin_ws/src/utilities/scan_tools/laser_scan_splitter/include " STREQUAL " ")
  set(laser_scan_splitter_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/src/utilities/scan_tools/laser_scan_splitter/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'laser_scan_splitter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/utilities/scan_tools/laser_scan_splitter/${idir}'.  Ask the maintainer 'Ivan Dryanovski <ccnyroboticslab@gmail.com>, Carlos <cjaramillo@gc.cuny.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${laser_scan_splitter_dep}_FOUND)
      find_package(${laser_scan_splitter_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${laser_scan_splitter_dep} REQUIRED ${depend_list})
  endif()
