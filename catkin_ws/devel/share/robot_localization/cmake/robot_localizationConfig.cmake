...
if("TRUE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/robot_localization)
  set(robot_localization_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(robot_localization_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT "/home/ubuntu/catkin_ws/devel/include;/home/ubuntu/catkin_ws/src/robot_localization/include " STREQUAL " ")
  set(robot_localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/devel/include;/home/ubuntu/catkin_ws/src/robot_localization/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/robot_localization/${idir}'.  Ask the maintainer 'Tom Moore <ayrton04@gmail.com>' to fix it.")
    endif()
    _list_append_unique(robot_localization_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "ekf;filter_base;filter_utilities;navsat_transform;ros_filter;ros_filter_utilities;ukf")
...
set(robot_localization_EXPORTED_TARGETS "robot_localization_generate_messages_cpp;robot_localization_generate_messages_lisp;robot_localization_generate_messages_py")
...
set(depends "cmake_modules;diagnostic_msgs;diagnostic_updater;geographic_msgs;geometry_msgs;message_filters;message_runtime;nav_msgs;roscpp;sensor_msgs;std_msgs;tf2;tf2_geometry_msgs;tf2_ros")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${robot_localization_dep}_FOUND)
      find_package(${robot_localization_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${robot_localization_dep} REQUIRED ${depend_list})
  endif()
