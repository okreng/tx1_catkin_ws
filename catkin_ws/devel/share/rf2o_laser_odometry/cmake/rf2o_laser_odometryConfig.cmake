...
if("TRUE" STREQUAL "TRUE")
  set(rf2o_laser_odometry_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/utilities/rf2o_laser_odometry)
  set(rf2o_laser_odometry_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(rf2o_laser_odometry_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT "/home/ubuntu/catkin_ws/src/utilities/rf2o_laser_odometry/include " STREQUAL " ")
  set(rf2o_laser_odometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/src/utilities/rf2o_laser_odometry/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rf2o_laser_odometry' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Javier G. Monroy <jgmonroy@uma.es>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rf2o_laser_odometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/utilities/rf2o_laser_odometry/${idir}'.  Ask the maintainer 'Javier G. Monroy <jgmonroy@uma.es>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rf2o_laser_odometry_dep}_FOUND)
      find_package(${rf2o_laser_odometry_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rf2o_laser_odometry_dep} REQUIRED ${depend_list})
  endif()
