...
//#include <infrastructure_to_vehicle/PointArray.h>
...
//  void pedestrianCb(const infrastructure_to_vehicle::PointArray &pointArray);
  void pedestrianCb(const geometry_msgs::PoseArray &poseArray);
  ...
  bool TransformInfrastructureToMap(geometry_msgs::PointStamped &ped_inf_frame, geometry_msgs::PointStamped &ped_map_frame);
  void InsertFakeObs();
