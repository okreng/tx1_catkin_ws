...
// This dummy pedestrian is just for the initial setup and will be replace by a list
#define DUMMYPEDESTRIAN ped_pos_.x = 999; ped_pos_.x = 0.365210;
                          ...
                          tf_listener_(nh, ros::Duration(5), true)
{
  ...
  pedestrian_sub_ = nh.subscribe("/predicted_points",1, &TrajClient::pedestrianCb, this);
  ...
  // TODO: change this message type to a list
  //ped_pos_pub_ = nh.advertise<geometry_msgs::PointStamped>("pedestrian_trajectory",1);
